...
export const NewsletterSignup = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 py-16 px-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-600"
                  required
                />
                <button
                  type="submit"
                  className="bg-teal-700 text-white px-8 py-3 font-bold hover:bg-teal-800 transition-colors whitespace-nowrap shadow-lg"
                >
                  Je m'inscris
                </button>
              </div>
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  className="mt-1 w-5 h-5 accent-teal-700 cursor-pointer"
                  required
                />
