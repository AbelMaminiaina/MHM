  ...
  const newsItems: NewsItem[] = [
    {
      ...
      title: "Madagascar : Le mouvement HFM appelle à la souveraineté nationale et à la défense des valeurs malagasy",
      author: 'Bureau Exécutif HFM',
    ...
    },
    {
      ...
      category: 'COMMUNIQUÉS',
      title: "Développement durable : Le HFM présente son programme pour la protection de l'environnement malagasy",
    ...
    },
    {
      ...
      category: 'VIDÉO',
      title: "Le président du HFM présente sa vision pour Madagascar : souveraineté, développement et fierté nationale",
      description: "Découvrez la vision complète du HFM pour un Madagascar souverain, prospère et fier de son identité. Un discours inspirant pour l'avenir de notre nation.",
      author: 'Président HFM',
      date: '27 octobre 2025',
      duration: '15:32',
      size: 'large',
    ...
    },
    {
      ...
      thumbnail: 'https://img.youtube.com/vi/0_eX_zSsfe8/maxresdefault.jpg',
      category: 'VIDÉO',
      title: "Interview exclusive : La jeunesse malgache s'engage pour l'avenir de Madagascar avec le HFM",
      description: "Les jeunes leaders du HFM partagent leur engagement pour transformer Madagascar. Une génération mobilisée pour le changement et la justice sociale.",
      author: 'Porte-parole Jeunesse HFM',
    ...
    },
    {
      ...
      category: 'COMMUNIQUÉS',
      title: "Agriculture et sécurité alimentaire : Le HFM propose un plan de valorisation des producteurs locaux",
      author: 'Val',
    ...
    },
    {
      ...
      category: 'COMMUNIQUÉS',
      title: "Éducation nationale : Le HFM demande la revalorisation du système éducatif malgache et la promotion du bilinguisme",
