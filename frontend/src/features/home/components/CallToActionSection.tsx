  ...
  return (
    <section className="w-full px-4 md:px-8 py-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 rounded-lg overflow-hidden shadow-lg">
        {/* Section Newsletter - Fond neutre */}
        <motion.div
          className="bg-gray-100 px-4 sm:px-6 py-6 sm:py-8 flex flex-col justify-center items-center cursor-pointer border-l-8 border-red-600"
        ...
        >
          <motion.h2
            className="text-gray-800 text-xs sm:text-sm font-bold mb-3 sm:mb-4 text-center"
        ...
        {/* Section Support - Fond neutre */}
        <motion.div
          className="bg-gray-50 px-4 sm:px-6 py-6 sm:py-8 flex flex-col justify-center items-center cursor-pointer border-l-8 border-red-600"
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          whileHover={{
            scale: 1.02,
