  ...
  const provinces: Province[] = [
    {
      ...
      population: '3,618,128',
      description: 'Capitale et plus grande ville de Madagascar, centre économique et politique du pays.'
    },
    {
      id: 'fianarantsoa',
      name: 'Fianarantsoa',
      capital: 'Fianarantsoa',
      population: '3,366,291',
      description: 'Province connue pour ses hauts plateaux et sa culture viticole.'
    },
    {
      id: 'toamasina',
      name: 'Toamasina',
      ...
      description: 'Principal port de Madagascar sur la côte est.'
    },
    {
      id: 'mahajanga',
      name: 'Mahajanga',
      ...
      description: 'Province située sur la côte nord-ouest, importante zone agricole.'
    },
    {
      id: 'toliara',
      name: 'Toliara',
      capital: 'Toliara',
      population: '2,229,550',
      description: 'Province du sud-ouest, connue pour ses plages et son climat sec.'
    },
    {
      id: 'antsiranana',
      name: 'Antsiranana',
      capital: 'Antsiranana (Diego-Suarez)',
      population: '1,311,100',
      description: 'Province du nord avec une importante base navale et de belles baies.'
    }
  ];
